...
Три схемы, каждая в светлой и тёмной версии:
...
- Три цветовые схемы, у каждой светлая и тёмная версия. Выбор запоминается.
...
- **Тесты на клиенте.** Сейчас покрыт сервер (44 теста: парсер SSE, разбор ошибок апстрима,
...
9. `docs` - этот README и скриншоты.
